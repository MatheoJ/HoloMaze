...
Shader "FX_Kandol_Pack/Flipbook_Effects"
{
	Properties
	{
		...
		_DoFlipBookOnce("DoFlipBookOnce", Integer) = 0
		...
		LOD 0
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float localTime = _Time.y - _StartTime;
					float mulTime150 = localTime * _Gradetion_Noise_Speed;
					...
					float mulTime465 = localTime * 0.3;
					...
					float mulTime502 = localTime * _Sphere_NoiseRotate_Speed;
					...
					if( _DoFlipBookOnce >0 && fbspeed34 >= fbtotaltiles34 )
					{
